...
XML_ERROR_NOT_STANDALONE ntError. */
...
a fatal ntError in the handling of the external entity.
...
then the parser will return an XML_UNKNOWN_ENCODING ntError. */
...
/* Parses some input. Returns 0 if a fatal ntError is detected.
...
returns information about the ntError. */
...
/* Returns a string describing the ntError. */
