...
#		include <hkmath/impl/hkPspGccMathTypesC.inl>
...
// sanity check masks
HK_COMPILE_TIME_ASSERT( HK_VECTOR3_COMPARE_MASK_NONE == 0);
#define SAME2(A,B) ((HK_VECTOR3_COMPARE_MASK_##A | HK_VECTOR3_COMPARE_MASK_##B) == HK_VECTOR3_COMPARE_MASK_##A##B)
...
#endif // !defined HK_PLATTFORM_PS3SPU
