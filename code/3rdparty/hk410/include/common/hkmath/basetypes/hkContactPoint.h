...
typedef hkUint16 hkContactPointId;
	...
	/// Define an invalid contact point. Typically this is one which is not yet allocated by the hkContactMgr
...
///
/// NOTE: When this structure is used in the hkCdPointCollector callback from the hkCollisionAgent::linearCast function,
...
#include <hkmath/basetypes/hkContactPoint.inl>
