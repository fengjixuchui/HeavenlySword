...
// Generated from 'hkscenedata/attributes/hkxSparselyAnimatedEnum.h'
...
{
	{ "type", &hkClassEnumClass, HK_NULL, hkClassMember::TYPE_POINTER, hkClassMember::TYPE_STRUCT, 0, 0, HK_OFFSET_OF(hkxSparselyAnimatedEnum,m_type) }
};
