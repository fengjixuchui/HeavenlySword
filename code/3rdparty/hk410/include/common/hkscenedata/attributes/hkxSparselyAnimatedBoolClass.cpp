...
// Generated from 'hkscenedata/attributes/hkxSparselyAnimatedBool.h'
...
{
	{ "bools", HK_NULL, HK_NULL, hkClassMember::TYPE_SIMPLEARRAY, hkClassMember::TYPE_BOOL, 0, 0, HK_OFFSET_OF(hkxSparselyAnimatedBool,m_bools) },
	{ "times", HK_NULL, HK_NULL, hkClassMember::TYPE_SIMPLEARRAY, hkClassMember::TYPE_REAL, 0, 0, HK_OFFSET_OF(hkxSparselyAnimatedBool,m_times) }
};
