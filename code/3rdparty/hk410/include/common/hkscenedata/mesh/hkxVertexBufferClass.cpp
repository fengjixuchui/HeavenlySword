...
// Generated from 'hkscenedata/mesh/hkxVertexBuffer.h'
...
{
	{ "vertexData", HK_NULL, HK_NULL, hkClassMember::TYPE_HOMOGENEOUSARRAY, hkClassMember::TYPE_VOID, 0, 0, HK_OFFSET_OF(hkxVertexBuffer,m_vertexDataClass) },
	{ "format", &hkxVertexFormatClass, HK_NULL, hkClassMember::TYPE_POINTER, hkClassMember::TYPE_STRUCT, 0, 0, HK_OFFSET_OF(hkxVertexBuffer,m_format) }
};
