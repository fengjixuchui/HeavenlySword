...
// Generated from 'hkscenedata/material/hkxTextureInplace.h'
...
{
	{ "fileType", HK_NULL, HK_NULL, hkClassMember::TYPE_CHAR, hkClassMember::TYPE_VOID, 4, 0, HK_OFFSET_OF(hkxTextureInplace,m_fileType) },
	{ "data", HK_NULL, HK_NULL, hkClassMember::TYPE_SIMPLEARRAY, hkClassMember::TYPE_UINT8, 0, 0, HK_OFFSET_OF(hkxTextureInplace,m_data) }
};
