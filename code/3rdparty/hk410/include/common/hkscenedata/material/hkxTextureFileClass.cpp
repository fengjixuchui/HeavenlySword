...
// Generated from 'hkscenedata/material/hkxTextureFile.h'
...
{
	{ "filename", HK_NULL, HK_NULL, hkClassMember::TYPE_CSTRING, hkClassMember::TYPE_VOID, 0, 0, HK_OFFSET_OF(hkxTextureFile,m_filename) }
};
