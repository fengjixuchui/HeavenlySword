...
namespace hkHavok400r1Classes
{
	extern hkClass hkConvexShapeClass;
}

namespace hkCompat_hk400r1_hk410b1
{
...
static void SkeletalAnimation_400r1_410b1(hkVariant& oldObj, hkVariant& newObj, hkObjectUpdateTracker& )
{
	hkClassAccessor newInstance(newObj);
	newInstance.member("type").asInt32() = getTypeValueFromEnumName( newObj, "HK_UNKNOWN_ANIMATION" );
}

static void InterleavedAnimation_400r1_410b1(hkVariant& oldObj, hkVariant& newObj, hkObjectUpdateTracker& )
{
	hkClassAccessor newInstance(newObj);
	newInstance.member("type").asInt32() = getTypeValueFromEnumName( newObj, "HK_INTERLEAVED_ANIMATION" );
}

static void DeltaAnimation_400r1_410b1(hkVariant& oldObj, hkVariant& newObj, hkObjectUpdateTracker& tracker )
{
	hkClassAccessor oldInstance(oldObj);
	hkClassAccessor newInstance(newObj);
	
	newInstance.member("type").asInt32() = getTypeValueFromEnumName( newObj, "HK_DELTA_COMPRESSED_ANIMATION" );
...
static void WaveletAnimation_400r1_410b1(
		hkVariant& oldObj,
		hkVariant& newObj,
		hkObjectUpdateTracker& tracker )
{
	...
	newInstance.member("type").asInt32() = getTypeValueFromEnumName( newObj, "HK_WAVELET_COMPRESSED_ANIMATION" );
...
static void hkShape_400r1_410b1(
	hkVariant& oldObj,
	hkVariant& newObj,
...
static void hkConvexListShape_400r1_410b1(
	hkVariant& oldObj,
	hkVariant& newObj,
	hkObjectUpdateTracker& )
{
	...
	if( newChildShapes.isOk() && oldChildShapes.isOk() )
	{
		...
		hkVariant v;
		v.m_class = &hkHavok400r1Classes::hkConvexShapeClass;
...
static void hkEntity_400r1_410b1(
								 hkVariant& oldObj,
								 hkVariant& newObj,
								 hkObjectUpdateTracker& )
{
...
static hkVersionUtil::ClassAction UpdateActions[] =
{
	...
	{ 0x91f785ca, 0x629b527c, hkVersionUtil::VERSION_COPY, "hkConvexListShape", hkConvexListShape_400r1_410b1 },
	{ 0x804c9b06, 0xfdcdf165, hkVersionUtil::VERSION_COPY, "hkWorldCinfo", HK_NULL },

	{ 0x32c2e1ad, 0x8b34c701, hkVersionUtil::VERSION_COPY, "hkEntity", hkEntity_400r1_410b1 },
	...
	{ 0xacd813d4, 0x700d0741, hkVersionUtil::VERSION_COPY, "hkSimpleShapePhantom", HK_NULL }, // +nosave, hkMotionState changed
	{ 0xacd813d4, 0x700d0741, hkVersionUtil::VERSION_COPY, "hkCachingShapePhantom", HK_NULL }, // hkMotionState changed
	{ 0xf19f2c14, 0x23d1cafd, hkVersionUtil::VERSION_COPY, "hkShapePhantom", HK_NULL }, // hkMotionState changed
	BINARY_IDENTICAL( 0x9c6fbcab, 0xd048fa36, "hkBridgeAtoms" ), // hkBridgeConstraintAtom fixed +nosave
	BINARY_IDENTICAL( 0xb0fd52fe, 0x75a59da4, "hkStiffSpringChainData" ), // hkBridgeConstraintAtom fixed +nosave
	BINARY_IDENTICAL( 0x62f8490e, 0xed5ae2e7, "hkPoweredChainData" ), // hkBridgeConstraintAtom fixed +nosave
	BINARY_IDENTICAL( 0xbfb72bac, 0x928cc3c6, "hkPointToPathConstraintData" ), // hkBridgeConstraintAtom fixed +nosave
	BINARY_IDENTICAL( 0x7388d1a7, 0x539a1164, "hkMalleableConstraintData" ), // hkBridgeConstraintAtom fixed +nosave
	BINARY_IDENTICAL( 0x379cfb19, 0x51d55528, "hkGenericConstraintData" ), // hkBridgeConstraintAtom fixed +nosave
	BINARY_IDENTICAL( 0xf7d52d22, 0x193acdb8, "hkBreakableConstraintData" ), // hkBridgeConstraintAtom fixed +nosave
	BINARY_IDENTICAL( 0xe7d0b220, 0x40ff6df8, "hkBallSocketChainData" ), // hkBridgeConstraintAtom fixed +nosave

	// hkcollide
	//BINARY_IDENTICAL( 0x9ab27645, 0x99dde7b9, "hkShape" ), // m_userData (void* -> hkUlong)
	{ 0x9ab27645, 0x99dde7b9, hkVersionUtil::VERSION_MANUAL, "hkShape", hkShape_400r1_410b1 }, // m_userData (void* -> hkUlong)

	
	{ 0xc21c54ff, 0x04e5e96d, hkVersionUtil::VERSION_COPY, "hkInterleavedSkeletalAnimation", InterleavedAnimation_400r1_410b1 },		
	{ 0xfdee6f42, 0xde5deced, hkVersionUtil::VERSION_COPY, "hkDeltaCompressedSkeletalAnimation", DeltaAnimation_400r1_410b1 },	
	{ 0x309d43f9, 0x724a7561, hkVersionUtil::VERSION_COPY, "hkDeltaCompressedSkeletalAnimationQuantizationFormat", HK_NULL },
	{ 0xfd1fe320, 0xacee09b8, hkVersionUtil::VERSION_COPY, "hkWaveletSkeletalAnimation", WaveletAnimation_400r1_410b1 },		
	{ 0x309d43f9, 0x724a7561, hkVersionUtil::VERSION_COPY, "hkWaveletSkeletalAnimationQuantizationFormat", HK_NULL },
	{ 0xb1aac849, 0x24b3d6bc, hkVersionUtil::VERSION_COPY, "hkSkeletalAnimation", SkeletalAnimation_400r1_410b1 },
