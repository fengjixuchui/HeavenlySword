...
namespace hkHavok320Classes
{
	const char VersionString[] = "Havok-3.2.0";
	...
	static const hkInternalClassEnumItem hkscenedata_attributes_hkxAttributehkxAttributeHintEnumItems[] =
	{
		{0, "HKX_HINT_NONE"},
		{1, "HKX_HINT_IGNORE"},
		{2, "HKX_HINT_TRANSFORM"},
		{4, "HKX_HINT_SCALE"},
		{6, "HKX_HINT_TRANSFORM_AND_SCALE"},
		{8, "HKX_HINT_FLIP"},
	};
	static const hkInternalClassEnum hkscenedata_attributes_hkxAttributeEnums[] = {
		{"hkxAttributeHint", hkscenedata_attributes_hkxAttributehkxAttributeHintEnumItems, 6 }
	};
	extern const hkClassEnum* hkxAttributeHintEnum = reinterpret_cast<const hkClassEnum*>(&hkscenedata_attributes_hkxAttributeEnums[0]);
	...
	static hkInternalClassMember hkPackfileHeaderClass_Members[] =
	{
		...
		{ "contentsVersion", HK_NULL, HK_NULL, hkClassMember::TYPE_CHAR, hkClassMember::TYPE_VOID, 12, 0, 0 },
	...
	static const hkInternalClassEnumItem hkdynamics_world_hkMultiThreadLockhkMultiThreadLockTypesEnumItems[] =
	{
		{0, "HK_ACCESS_IGNORE"},
		{1, "HK_ACCESS_RO"},
		{2, "HK_ACCESS_RW"},
	};
	static const hkInternalClassEnum hkdynamics_world_hkMultiThreadLockEnums[] = {
		{"hkMultiThreadLockTypes", hkdynamics_world_hkMultiThreadLockhkMultiThreadLockTypesEnumItems, 3 }
	};
	extern const hkClassEnum* hkMultiThreadLockTypesEnum = reinterpret_cast<const hkClassEnum*>(&hkdynamics_world_hkMultiThreadLockEnums[0]);
	...
	{
		{ "anglesAreNotStoredInHavok30Format", HK_NULL, HK_NULL, hkClassMember::TYPE_BOOL, hkClassMember::TYPE_VOID, 0, 0, 0 },
	...
	namespace
	{
		...
		{
			{-1,-1,-1,-1,-1,-1,-1,-1,-1,HK_OFFSET_OF(hkRagdollConstraintData_DefaultStruct,m_angularLimitsTauFactor)},
			0.8f
		};
	}
