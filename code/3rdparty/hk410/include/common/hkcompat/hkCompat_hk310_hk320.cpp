...
static void Noop( hkVariant&, hkVariant&, hkObjectUpdateTracker& )
{
}
...
static hkVersionUtil::ClassAction UpdateActions[] =
{
	...
	// World object
	{ 0xed9026c5, 0x3719b83d, hkVersionUtil::VERSION_INPLACE, "hkAabbPhantom", ZeroUserDataPointer }, // overlapping collidables zeroed
	{ 0xef9cf8a1, 0x4937bb81, hkVersionUtil::VERSION_COPY, "hkEntity", ZeroUserDataPointer },	// new uid member added, userdata->zero
	{ 0xef940b7c, 0x4bcc8a37, hkVersionUtil::VERSION_COPY, "hkWorldCinfo", HK_NULL }, // New members + defaults
	{ 0x1718f806, 0xd858a951, hkVersionUtil::VERSION_INPLACE, "hkWorldObject", ZeroUserDataPointer },  // broadphase border enum added, userdata->zero
	...
	{ 0x51a73ef8, 0x1cd2a3e1, hkVersionUtil::VERSION_MANUAL, "hkMeshShapeSubpart", Noop }, // type of subpart members changed
		
	// Vehicle
	{ 0x26f7cf9f, 0xcd195550, hkVersionUtil::VERSION_COPY, "hkVehicleInstance", HK_NULL }, // Changed friction Status
...
{
	static hkBool computedOffsets320;
	if( computedOffsets320 == false )
	{
		hkVersionUtil::recomputeClassMemberOffsets( hkVersionUpdateDescription.classes );
		computedOffsets320 = true;
	}
