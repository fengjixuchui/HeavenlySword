...
namespace hkHavok330r1Classes
{
	const char VersionString[] = "Havok-3.3.0-r1";
	...
	{
		{ "rotatedPlaneEquations", HK_NULL, HK_NULL, hkClassMember::TYPE_TRANSFORM, hkClassMember::TYPE_VOID, 0, 0, 0 },
