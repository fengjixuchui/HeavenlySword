...
namespace hkHavok400b2Classes
{
	const char VersionString[] = "Havok-4.0.0-b2";
	...
	namespace
	{
		...
		{
			{-1,-1,-1,-1,HK_OFFSET_OF(hkbRagdollDriverModifier_DefaultStruct,m_lastModifierNotBlended)},
			HK_NULL
		};
	}
	...
	static const hkInternalClassEnum hkbBlendingTransitionEnums[] = {
		{"FlagsBT", hkbBlendingTransitionFlagsBTEnumItems, 4 }
	};
	...
	{
		{ "buildJacobianFunc", HK_NULL, HK_NULL, hkClassMember::TYPE_POINTER, hkClassMember::TYPE_VOID, 0, 0, 0 },
