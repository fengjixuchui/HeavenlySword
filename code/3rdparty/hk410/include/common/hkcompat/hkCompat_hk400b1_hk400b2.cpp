	...
	hkObjectUpdateTracker& )
{
	...
	{
		if ( oldSynchronizeFrameAndPhysicsTime.asBool() == true )
		{
	...
	hkObjectUpdateTracker& tracker)
{
	...
	hkTransform transformA;
	{
		...
		HK_ON_DEBUG( diff.setSub4(shaftA, transformA.getColumn(0)) );
		HK_ASSERT2(0xad88aad7, hkMath::equal( diff.lengthSquared3(), 0.0f ), "Error in converting prismatic constraint.");
	...
	hkObjectUpdateTracker& )
{
	...
	hkRotation rotationB;
	{
		...
		HK_ASSERT2(0xad78dd9a, hkMath::equal( referenceAxle.dot3(steeringAxis), 0), "Error when versioning wheel constraint: Wheel axle and steering axis must be perpendicular.");
...
static hkUint8 MotionTypeFromClassName(const char* className, const hkClassEnum& motionEnum )
{
	...
	HK_ASSERT2(0x23107483, val != 0,"Unrecognised motion type " << className );
	return hkUint8(val);
}
...
{
	//physics
	{ 0x4bcc8a37, 0x804c9b06, hkVersionUtil::VERSION_COPY, "hkWorldCinfo", WorldCinfoVersion_400b1_400b2 }, // several members changed, simulation type
	{ 0x8e3d544b, 0x4c1e648e, hkVersionUtil::VERSION_COPY, "hkCharacterProxyCinfo", CharacterCinfoVersion_440b1_400b2 },

	// vehicle
	{ 0x037ed0ee, 0x82fe40e0, hkVersionUtil::VERSION_COPY, "hkVehicleDataWheelComponentParams", HK_NULL }, // added slipAngle
	{ 0xad76bdca, 0xd6ea9f63, hkVersionUtil::VERSION_COPY, "hkVehicleData", HK_NULL }, // WheelComponentParams
	...
	{ 0x8cfd83a5, 0xe082f555, hkVersionUtil::VERSION_COPY, "hkBallAndSocketConstraintData", BallAndSocketConstraintData_400b1_400b2 },
	{ 0xb95c56e9, 0xe7d0b220, hkVersionUtil::VERSION_COPY, "hkBallSocketChainData", BallSocketChainData_400b1_400b2 },
	{ 0x5e46058f, 0xf7d52d22, hkVersionUtil::VERSION_COPY, "hkBreakableConstraintData", BreakableConstraintData_400b1_400b2 },
	{ 0x50520e7d, 0x2d0d9c11, hkVersionUtil::VERSION_COPY, "hkConstraintInstance", ConstraintInstance_400b1_400b2 },
	{ 0x78e48550, 0x379cfb19, hkVersionUtil::VERSION_COPY, "hkGenericConstraintData", GenericConstraintData_400b1_400b2 },
	{ 0x32ca9356, 0xc395390f, hkVersionUtil::VERSION_COPY, "hkHingeConstraintData", HingeConstraintData_400b1_400b2 },
	{ 0xc6b7095b, 0xc5d5f36c, hkVersionUtil::VERSION_COPY, "hkPoweredHingeConstraintData", PoweredHingeConstraintData_400b1_400b2 },
	{ 0xc0567fcb, 0xc5d5f36c, hkVersionUtil::VERSION_COPY, "hkLimitedHingeConstraintData", LimitedHingeConstraintData_400b1_400b2 },
	{ 0x6c9bb90f, 0x6174805f, hkVersionUtil::VERSION_COPY, "hkHingeLimitsData", HingeLimitsData_400b1_400b2 },
	{ 0x8a7d73d8, 0x7388d1a7, hkVersionUtil::VERSION_COPY, "hkMalleableConstraintData", MalleableConstraintData_400b1_400b2 },
	{ 0xc9d61d09, 0xbfb72bac, hkVersionUtil::VERSION_COPY, "hkPointToPathConstraintData", PointToPathConstraintData_400b1_400b2 },
	{ 0x6d93acbf, 0x4ffbb9c8, hkVersionUtil::VERSION_COPY, "hkPointToPlaneConstraintData", PointToPlaneConstraintData_400b1_400b2 },
	{ 0x86a24d53, 0x62f8490e, hkVersionUtil::VERSION_COPY, "hkPoweredChainData", PoweredChainData_400b1_400b2 },
	{ 0x8ae97a88, 0xe3f64b23, hkVersionUtil::VERSION_COPY, "hkPrismaticConstraintData", PrismaticConstraintData_400b1_400b2 },
	{ 0x519f80c6, 0x11e5ab7d, hkVersionUtil::VERSION_COPY, "hkPulleyConstraintData", PulleyConstraintData_400b1_400b2 },
	{ 0xa4c8a325, 0xc651255c, hkVersionUtil::VERSION_COPY, "hkPoweredRagdollConstraintData", PoweredRagdollConstraintData_400b1_400b2 },
	{ 0x6bf721fa, 0xc651255c, hkVersionUtil::VERSION_COPY, "hkRagdollConstraintData", RagdollConstraintData_400b1_400b2 },
	{ 0xca988c50, 0x80dae155, hkVersionUtil::VERSION_COPY, "hkRagdollLimitsData", RagdollLimitsData_400b1_400b2 },
	{ 0x8529098a, 0xb0fd52fe, hkVersionUtil::VERSION_COPY, "hkStiffSpringChainData", StiffSpringChainData_400b1_400b2 },
	{ 0xf8227619, 0x90270268, hkVersionUtil::VERSION_COPY, "hkStiffSpringConstraintData", StiffSpringConstraintData_400b1_400b2 },
	{ 0xc8243370, 0x7c2ac049, hkVersionUtil::VERSION_COPY, "hkWheelConstraintData", WheelConstraintData_400b1_400b2 },
	{ 0x82ef3c01, 0x27169465, hkVersionUtil::VERSION_COPY, "hkConstraintMotor", ConstraintMotor_400b1_400b2 },
	{ 0xde4be9fc, 0xf28ab3b7, hkVersionUtil::VERSION_COPY, "hkConstraintData", HK_NULL }, // added 

	// motionstate
	{ 0x0a3b3785, 0x332f16fa, hkVersionUtil::VERSION_COPY, "hkMotionState", HK_NULL }, // ang/lin damping added
	{ 0xe5e9b095, 0x954011fd, hkVersionUtil::VERSION_COPY, "hkShapePhantom", HK_NULL }, // contains a motionstate

	// motion
	{ 0xb68fb987, 0x9f0bf6ee, hkVersionUtil::VERSION_COPY, "hkBoxMotion", Motion_400b1_400b2 }, // no members
	{ 0x10e3bfce, 0x27f50bfa, hkVersionUtil::VERSION_COPY, "hkKeyframedRigidMotion", Motion_400b1_400b2 }, //
	{ 0xe6f30c22, 0x9f0bf6ee, hkVersionUtil::VERSION_COPY, "hkSphereMotion", Motion_400b1_400b2 }, //
	REMOVED("hkRigidMotion"), // in fact, renamed to hkMotion
	{ 0x953b00d8, 0x179f1a0b, hkVersionUtil::VERSION_COPY, "hkMotion", Motion_400b1_400b2 }, // members pushed up to base class
	{ 0x12d39c57, 0x5c97b8e7, hkVersionUtil::VERSION_COPY, "hkEntity", Entity_400b1_400b2 }, // motion moved inside, fixed flags removed
	...
	{ 0xbe368383, 0x6a48b9cc, hkVersionUtil::VERSION_COPY, "hkbBlendingTransition", HK_NULL },
	{ 0xdbc8239b, 0x854b920e, hkVersionUtil::VERSION_COPY, "hkbPoweredRagdollModifier", HK_NULL },
	{ 0x6df0560c, 0x0015833d, hkVersionUtil::VERSION_COPY, "hkbRigidBodyRagdollModifier", HK_NULL },
	{ 0xd53589db, 0xa435f17d, hkVersionUtil::VERSION_COPY, "hkbStateMachine", HK_NULL },
	{ 0x635bd2ce, 0x0d44f6e7, hkVersionUtil::VERSION_COPY, "hkbVariableSetTarget", HK_NULL },
	BINARY_IDENTICAL( 0x1985ec3f, 0xd776a823, "hkbVariableSet" ),
	BINARY_IDENTICAL( 0x98c8f7df, 0x6164be0e, "hkbVariableSetVariable" ),
	...
	hkObjectUpdateTracker& tracker )
{
	...
	if (res == HK_SUCCESS)
	{
		...
		res = hkVersionUtil::updateSingleVersion( motionsInOut, tracker, hkVersionUpdateDescription );
