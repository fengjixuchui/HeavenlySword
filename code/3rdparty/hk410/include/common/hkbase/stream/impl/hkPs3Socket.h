...
#ifndef HK_BASE_PS3_SOCKET_H
#define HK_BASE_PS3_SOCKET_H

#include <hkbase/hkBase.h>
#include <hkbase/stream/hkSocket.h>

class hkPs3Socket : public hkSocket
{
	public:
		...
		hkPs3Socket(socket_t s=socket_t(-1));
...
/// Set up ps3 network. Set hkSocket::s_platformNetInit to HK_NULL to prevent this being called
void HK_CALL hkPs3NetworkInit();

/// Set up ps3 network. Set hkSocket::s_platformNetQuit to HK_NULL to prevent this being called
void HK_CALL hkPs3NetworkQuit();

#endif // HK_BASE_PS3_SOCKET_H
