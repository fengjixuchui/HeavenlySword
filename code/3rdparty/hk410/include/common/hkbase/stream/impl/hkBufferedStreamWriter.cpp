...

{
	...
	HK_ASSERT2( 0x68c094d2, bufSize % BUFFER_BLOCK_SIZE == 0, "block size needs to be a multiple of " << BUFFER_BLOCK_SIZE );
	m_buf = hkAlignedAllocate<char>( BUFFER_ALIGNMENT, bufSize, HK_MEMORY_CLASS_STREAM );
	m_bufSize = 0;
