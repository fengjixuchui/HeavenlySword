...
struct hkSpuDmaCacheLine
{
	...
	hkPadSpuLong<HK_CPU_PTR(const ElemType*)> m_originalAddress;
...
class hkSpuDmaCache
{
	...
	public:
		...
		/*HK_FORCE_INLINE*/ const ElemType* getFromMainMemory(HK_CPU_PTR(const ElemType*) addressInMainMemory);
			...
			/// Wait until supplied object has been sucessfully uploaded from main memory.
			///
...
#include <hkbase/memory/dmacache/hkSpuDmaCache.inl>
