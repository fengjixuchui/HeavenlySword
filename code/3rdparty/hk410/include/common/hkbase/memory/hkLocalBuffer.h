...
#ifndef HKBASE_HK_LOCAL_BUFFER_H
...
class hkFixedArray
{
	public:
		...
		HK_ON_DEBUG( HK_FORCE_INLINE int getSizeDebug() const { return m_debugSize; } )
...
class hkLocalBuffer: public hkFixedArray<T>
{
	public:
		...
		HK_FORCE_INLINE hkLocalBuffer(int n);
...
template <typename T>
HK_FORCE_INLINE hkLocalBuffer<T>::hkLocalBuffer( int capacity )
{
