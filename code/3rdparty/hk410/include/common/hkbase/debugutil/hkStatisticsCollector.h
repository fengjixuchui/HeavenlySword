	...
	public:
		...
		enum StatisticClass
		{
			MEMORY_ALL = 0xf,
				...
				/// shared between hkWorlds, e.g. hkShapes, mopp, hkConstraintData
			MEMORY_SHARED = 1,
			...
			MEMORY_INSTANCE = 2,
				/// Extra (fixed size) overhead added by the engine for every static object,e.g hkConstraintRuntime.
			MEMORY_ENGINE = 4,
