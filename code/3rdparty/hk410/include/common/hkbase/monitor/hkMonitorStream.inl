...
#include <hkbase/monitor/hkXBox360MonitorStream.inl>
#endif
...
#define HK_TIME_CODE_BLOCK( NAME, OBJECT ) HK_TIMER_BEGIN(NAME, OBJECT); hkTimeFunctionHelper helper
...
#else // HK_CONFIG_MONITORS != HK_CONFIG_MONITORS_ENABLED
...
#endif // HK_CONFIG_MONITORS == HK_CONFIG_MONITORS_ENABLED

#ifndef HK_PLATFORM_PS3SPU
#	define HK_CPU_TIMER_BEGIN(NAME, OBJECT)		HK_TIMER_BEGIN(NAME,OBJECT)
#	define HK_CPU_TIMER_END				HK_TIMER_END
#	define HK_CPU_TIMER_BEGIN_LIST(a,b)	HK_TIMER_BEGIN_LIST(a,b)
#	define HK_CPU_TIMER_SPLIT_LIST(a)		HK_TIMER_SPLIT_LIST(a)
#	define HK_CPU_TIMER_END_LIST			HK_TIMER_END_LIST
#	define HK_CPU_MONITOR_ADD_VALUE(NAME, VALUE, MONITOR_TYPE)		HK_MONITOR_ADD_VALUE(NAME, VALUE, MONITOR_TYPE)
#else
#	define HK_CPU_TIMER_BEGIN(NAME,OBJECT)		{}
#	define HK_CPU_TIMER_END()				{}
#	define HK_CPU_TIMER_BEGIN_LIST(a,b)	{}
#	define HK_CPU_TIMER_SPLIT_LIST(a)		{}
#	define HK_CPU_TIMER_END_LIST()		{}
#endif
