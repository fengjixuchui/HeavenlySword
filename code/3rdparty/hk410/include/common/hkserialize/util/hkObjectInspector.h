...
namespace hkObjectInspector
{
	...
	class ObjectListener
	{
		...
		/// for virtual object. However, in some cases where the base
		/// class for virtual object is unknown it contains HK_NULL.
	hkResult getPointers(const void* object, const hkClass& klass, hkArray<Pointer>& outContainedPointers);
	...
	hkResult walkPointers(const void* object, const hkClass& klass, ObjectListener* listener);
}
