 ...
 * 
 */
#ifndef HK_SERIALIZE_FINISH_LOADED_OBJECT_REGISTRY_H
#define HK_SERIALIZE_FINISH_LOADED_OBJECT_REGISTRY_H
...
class hkFinishLoadedObjectRegistry : public hkReferencedObject
{
	public:

		hkFinishLoadedObjectRegistry() {}
		...
		virtual const hkTypeInfo* finishLoadedObject( void* obj, const char* className ) const
		{
			...
			{
				HK_WARN(0x4e34ea5f, "Class " << className << " not found in hkFinishLoadedObjectRegistry. Has it been registered?" );
			}
			return t;
		}
		...
		virtual void merge(const hkFinishLoadedObjectRegistry& mergeFrom) 
		{
...
#endif // HK_SERIALIZE_FINISH_LOADED_OBJECT_REGISTRY_H
