 ...
 * 
 */
#ifndef HK_SERIALIZE_CLASS_VTABLE_REGISTRY_H
#define HK_SERIALIZE_CLASS_VTABLE_REGISTRY_H

#include <hkbase/htl/hkPointerMap.h>
#include <hkbase/class/hkTypeInfo.h>

/// Registry of vtables to hkClass instances.
class hkVtableClassRegistry : public hkReferencedObject
{
	public:
...
#endif // HK_SERIALIZE_CLASS_VTABLE_REGISTRY_H
