...
namespace hkVersionCheckingUtils
{
	...
	hkResult HK_CALL verifyUpdateDescription( hkOstream& report, hkClass*const* oldClasses, const hkVersionUtil::UpdateDescription& updateDescription, bool verbose = false );
}
