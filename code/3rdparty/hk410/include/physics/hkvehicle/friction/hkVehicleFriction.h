...
/// The class hkVehicleFrictionDescription is used by vehicle dynamics as a const description
/// of how to simulate the friction of a vehicle this class can be initialized using
/// hkVehicleFrictionDescriptionInitValues()
struct hkVehicleFrictionDescription
{
	HK_DECLARE_REFLECTION();
	HK_DECLARE_NONVIRTUAL_CLASS_ALLOCATOR(HK_MEMORY_CLASS_ACTION, hkVehicleFrictionDescription);
	
		/// A helper construction info class to fill in the values for a hkVehicleFrictionDescription.
...
struct hkVehicleFrictionStatus
{
		HK_DECLARE_REFLECTION();
		HK_DECLARE_NONVIRTUAL_CLASS_ALLOCATOR(HK_MEMORY_CLASS_CONSTRAINT, hkVehicleFrictionStatus);
		...
		hkVehicleFrictionStatus( hkFinishLoadedObjectFlag flag ) 
		{ 
