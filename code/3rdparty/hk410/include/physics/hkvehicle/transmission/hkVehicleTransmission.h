...
/// The hkVehicleTransmission of a vehicle is responsible for calculating all the
...
/// This component usually collaborates with the hkVehicleEngine, the
/// hkVehicleDriverInput and the hkVehicleInstance in order to calculate its new
/// state.
class hkVehicleTransmission : public hkReferencedObject
{
	public:
		...
		virtual void calcTransmission(const hkReal deltaTime, const hkVehicleInstance* vehicle, TransmissionOutput& transmissionOut) = 0;
};
