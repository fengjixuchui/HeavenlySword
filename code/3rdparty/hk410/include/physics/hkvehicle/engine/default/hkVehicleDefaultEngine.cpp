...
HK_REFLECTION_DEFINE_VIRTUAL(hkVehicleDefaultEngine);

hkVehicleDefaultEngine::hkVehicleDefaultEngine()
{
	m_minRPM = 1000.0f;
	m_optRPM = 4000.0f;
	m_maxRPM = 6000.0f;
...
void hkVehicleDefaultEngine::calcEngineInfo( const hkReal deltaTime, const hkVehicleInstance* vehicle, const hkVehicleDriverInput::FilteredDriverInputOutput& filteredDriverInputInfo, const hkVehicleTransmission::TransmissionOutput& transmissionInfo, EngineOutput& engineOutput )
{
