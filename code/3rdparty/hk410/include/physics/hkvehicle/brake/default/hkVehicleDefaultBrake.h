...
/// The class hkVehicleDefaultBrake implements a braking system that is independent at
...
class hkVehicleDefaultBrake : public hkVehicleBrake
{
	public:
		...
		virtual void calcBreakingInfo(const hkReal deltaTime, const hkVehicleInstance* vehicle, const hkVehicleDriverInput::FilteredDriverInputOutput& FilteredDriverInputOutput, WheelBreakingOutput& breakingInfo);
	...
	public:
		hkVehicleDefaultBrake(hkFinishLoadedObjectFlag f) : m_wheelBrakingProperties(f) { }
};
