...
HK_REFLECTION_DEFINE_VIRTUAL(hkVehicleData);

hkVehicleData::hkVehicleData()
{
	m_numWheels = 0;
...
void hkVehicleData::init( const hkArray<struct hkVehicleSuspension::SuspensionWheelParameters>& suspensionWheelParams, hkRigidBody* chassis)
{
	...
	{
		hkVehicleFrictionDescription::Cinfo ci;
...
void hkVehicleData::calcStatistics( hkStatisticsCollector* collector ) const
{
