...
/// The hkVehicleDefaultSuspension class implements a default, spring-based, suspension
/// module for vehicles.
class hkVehicleDefaultSuspension : public hkVehicleSuspension
{
	public:
		...
		virtual void calcSuspension(const hkReal deltaTime, const hkVehicleInstance* vehicle, const hkVehicleWheelCollide::CollisionDetectionWheelOutput* cdInfo, hkReal* suspensionForceOut);
	...
	public:
		hkVehicleDefaultSuspension(hkFinishLoadedObjectFlag f) : hkVehicleSuspension(f), m_wheelSpringParams(f) { }
};
