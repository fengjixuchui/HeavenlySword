...
HK_REFLECTION_DEFINE_VIRTUAL(hkVehicleDefaultVelocityDamper);

hkVehicleDefaultVelocityDamper::hkVehicleDefaultVelocityDamper()
{
...
void hkVehicleDefaultVelocityDamper::applyVelocityDamping(const hkReal deltaTime, hkVehicleInstance& vehicle )
{
	hkRigidBody*	chassis_motionstate = vehicle.getChassis();
