...
#define HK_1D_ANGULAR_FOLLOW_COM_CINFO
	...
	/// All the parameters needed to construct a hk1dAngularFollowCam
class hk1dAngularFollowCamCinfo 
{
	public:
		
		HK_DECLARE_NONVIRTUAL_CLASS_ALLOCATOR(HK_MEMORY_CLASS_CAMERA, hk1dAngularFollowCamCinfo);

		hk1dAngularFollowCamCinfo();
