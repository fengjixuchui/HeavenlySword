...
/// The hk1dAngularFollowCam attaches a camera to a vehicle to aid rendering.
...
/// See hk1dAngularFollowCamCinfo for parameter description
class hk1dAngularFollowCam : public  hkReferencedObject
{
	public:

			/// Default constructor
		hk1dAngularFollowCam ();

			/// Constructor.
		hk1dAngularFollowCam (const hk1dAngularFollowCamCinfo &bp);

			/// Destructor.
		virtual ~hk1dAngularFollowCam();

			/// Reset all values except pointer values.
		void reinitialize( const hk1dAngularFollowCamCinfo &bp );
	...
	protected:
		...
		hk1dAngularFollowCamCinfo::CameraSet m_set[2];
