...
/// individual wheel steering angles. The hkVehicleSteering class is responsible
...
/// input value from the vehicle's hkVehicleDriverInput and transform it into a
/// steering angle.
class hkVehicleSteering : public hkReferencedObject
{
	public:
		...
		virtual void calcSteering(const hkReal deltaTime, const hkVehicleInstance* vehicle, const hkVehicleDriverInput::FilteredDriverInputOutput& filteredInfoOutput, SteeringAnglesOutput& steeringOutput ) = 0;
};
