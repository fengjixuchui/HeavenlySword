...
/// The hkVehicleDefaultSteering class implements a hkVehicleSteering that maps the
/// steering input from the hkVehicleDriverInput to a main steering angle, using a
...
class hkVehicleDefaultSteering : public hkVehicleSteering
{
	public:
		...
		virtual void calcSteering(const hkReal deltaTime, const hkVehicleInstance* vehicle, const hkVehicleDriverInput::FilteredDriverInputOutput& filteredInfoOutput, SteeringAnglesOutput& steeringOutput );
		
			/// Calculates the main steering angle.
		virtual void calcMainSteeringAngle( const hkReal deltaTime, const hkVehicleInstance* vehicle, const hkVehicleDriverInput::FilteredDriverInputOutput& filteredInfoOutput, SteeringAnglesOutput& steeringOutput );
	...
	public:
		hkVehicleDefaultSteering(hkFinishLoadedObjectFlag f) : m_doesWheelSteer(f) { }
};
