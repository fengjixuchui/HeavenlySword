 ...
 * 
 */
#ifndef HKVEHICLE_AERODYNAMICs_hkVehicleAERODYNAMICs_XML_H
#define HKVEHICLE_AERODYNAMICs_hkVehicleAERODYNAMICs_XML_H

#include <hkmath/hkMath.h>

class hkVehicleInstance;

/// The hkVehicleAerodynamics is responsible for providing the total force and
...
class hkVehicleAerodynamics : public hkReferencedObject
{
	public:
		...
		virtual void calcAerodynamics(const hkReal deltaTime, const hkVehicleInstance* vehicle, AerodynamicsDragOutput& dragInfoOut) = 0;
};

#endif // HKVEHICLE_AERODYNAMICs_hkVehicleAERODYNAMICs_XML_H
