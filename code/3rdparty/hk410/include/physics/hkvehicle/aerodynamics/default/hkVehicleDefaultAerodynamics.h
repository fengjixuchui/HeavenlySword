...
/// The hkVehicleDefaultAerodynamics class implements an
...
class hkVehicleDefaultAerodynamics : public hkVehicleAerodynamics
{
	public:
		...
		virtual void calcAerodynamics(const hkReal deltaTime, const hkVehicleInstance* vehicle, AerodynamicsDragOutput& dragInfoOut);
	...
	public: 
		hkVehicleDefaultAerodynamics( hkFinishLoadedObjectFlag f ) { }
