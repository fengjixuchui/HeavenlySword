...
/// An hkEntityDeactivator is created for every entity. This tells the system when it is safe to deactivate the entity.
...
class hkEntityDeactivator : public hkReferencedObject
{
	public:
		...
		virtual hkBool shouldDeactivateHighFrequency( const hkEntity* entity ) = 0;
		...
		virtual hkBool shouldDeactivateLowFrequency( const hkEntity* entity ) = 0;
	...
	public:
		...
		hkEntityDeactivator( class hkFinishLoadedObjectFlag flag ) {}
};
