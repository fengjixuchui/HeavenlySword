...
extern const hkClass hkSpatialRigidBodyDeactivatorClass;
	...
	/// by hand. One of these objects is automatically created on construction of each hkRigidBody.
class hkSpatialRigidBodyDeactivator : public hkRigidBodyDeactivator
{
	...
	public:
		...
		hkSpatialRigidBodyDeactivator( class hkFinishLoadedObjectFlag flag ) {}
};
