...
class hkBreakableConstraintEvent
{
	public:
		hkConstraintInstance *m_constraintInstance;
		hkBreakableConstraintData* m_breakableConstraintData;
...
class hkBreakableListener
{
	public:
		...
		virtual void constraintBrokenCallback(hkBreakableConstraintEvent& event) = 0;

			/// Virtual destructor for derived objects
		virtual ~hkBreakableListener() {}
};
