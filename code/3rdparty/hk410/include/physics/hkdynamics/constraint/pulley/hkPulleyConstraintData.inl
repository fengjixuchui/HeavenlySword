...
inline void hkPulleyConstraintData::setInWorldSpace(const hkTransform& bodyATransform,
...
inline void hkPulleyConstraintData::setInBodySpace( const hkTransform& bodyATransform,
													 const hkTransform& bodyBTransform,
...
hkReal hkPulleyConstraintData::getRopeLength(hkReal length) 
{ 
	return m_atoms.m_pulley.m_ropeLength; 
}

hkReal hkPulleyConstraintData::getLeverageOnBodyB() 
{ 
	return m_atoms.m_pulley.m_leverageOnBodyB; 
}

void hkPulleyConstraintData::setRopeLength(hkReal length)
{
	m_atoms.m_pulley.m_ropeLength = length;
}

void hkPulleyConstraintData::setLeverageOnBodyB(hkReal leverageOnBodyB)
{
	m_atoms.m_pulley.m_leverageOnBodyB = leverageOnBodyB;
}
