...
class hkPositionConstraintMotor : public hkLimitedForceConstraintMotor
{
	public:
		...
		hkPositionConstraintMotor( hkReal currentPosition = 0.0f);
	...
	public:
		...
		hkPositionConstraintMotor(hkFinishLoadedObjectFlag f) : hkLimitedForceConstraintMotor(f) {}
