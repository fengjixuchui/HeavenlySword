...
class hkLimitedForceConstraintMotor : public hkConstraintMotor
{
	public:
		...
		HK_DECLARE_REFLECTION();
			...
			/// Constructor
		inline hkLimitedForceConstraintMotor(){}
	...
	public:
		...
		hkLimitedForceConstraintMotor(hkFinishLoadedObjectFlag f) : hkConstraintMotor(f) {}
