...
class hkSpringDamperConstraintMotor : public hkLimitedForceConstraintMotor
{
	public:
		...
		hkSpringDamperConstraintMotor( hkReal springConstant, hkReal springDamping, hkReal maxForce  = HK_REAL_MAX);
	...
	public:
		...
		hkSpringDamperConstraintMotor(hkFinishLoadedObjectFlag f) : hkLimitedForceConstraintMotor(f)  {}
};
