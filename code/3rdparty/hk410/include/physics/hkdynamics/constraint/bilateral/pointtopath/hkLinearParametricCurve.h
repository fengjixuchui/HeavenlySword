...
class hkLinearParametricCurve : public hkParametricCurve
{
	public:
		...
		virtual hkBool isClosedLoop() const;
			...
			// hkLinearParametricCurve interface
	...
	public:
		...
		hkLinearParametricCurve(hkFinishLoadedObjectFlag f) : m_points(f), m_distance(f) {}
