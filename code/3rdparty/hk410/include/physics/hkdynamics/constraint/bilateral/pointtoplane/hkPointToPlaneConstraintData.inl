...
inline void hkPointToPlaneConstraintData::setInWorldSpace(const hkTransform& bodyATransform,
...
inline void hkPointToPlaneConstraintData::setInBodySpace( const hkVector4& pivotA,const hkVector4& pivotB, const hkVector4& planeNormalA )
{
	m_pivotInA = pivotA;
	m_pivotInB = pivotB;	
