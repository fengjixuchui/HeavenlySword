...
class hkStiffSpringConstraintData : public hkConstraintData
{
	public:
	...
	public:
		...
		struct Atoms
		{
			...
			struct hkStiffSpringConstraintAtom			m_spring;
	...
	public:
		...
		hkStiffSpringConstraintData(hkFinishLoadedObjectFlag f) : hkConstraintData(f), m_atoms(f) {}
};


#include <hkdynamics/constraint/bilateral/stiffspring/hkStiffSpringConstraintData.inl>
