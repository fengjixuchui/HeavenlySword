...
class hkSphereMotion : public hkMotion
{
	public:

		HK_DECLARE_REFLECTION();

		hkSphereMotion(const hkVector4& position, const hkQuaternion& rotation):
	...
	public:
		...
		hkSphereMotion( class hkFinishLoadedObjectFlag flag ) : hkMotion( flag ) {}
};
