...
#define HK_PHANTOM_SHAPE_CHANGE_ERROR_TEXT "Setting the shape of a hkShapePhantom while it is in the world is very dangerous!" \
...
inline const hkTransform& hkShapePhantom::getTransform() const
{
