...
class hkMaterial
{
	public:
		...
		//
			...
			/// A list of some response types as initially set up by the hkWorld constructor,
		...
		inline void setResponseType( enum hkMaterial::ResponseType t );

			/// Set the response type. See the description of hkRepsonseType for details.
		inline enum hkMaterial::ResponseType getResponseType() const;
	...
	public:
		...
		hkMaterial( class hkFinishLoadedObjectFlag flag ) { }
};

#include <hkdynamics/common/hkMaterial.inl>
