...
class hkStepInfo;
	...
	/// Add to the Island using hkWorld::addIslandPostCollideListener
class hkIslandPostCollideListener
{
	public:

		virtual ~hkIslandPostCollideListener() {}

			/// called after collision detection is performed
		virtual void postCollideCallback( hkSimulationIsland* Island, const hkStepInfo& stepInfo ) = 0;
};
