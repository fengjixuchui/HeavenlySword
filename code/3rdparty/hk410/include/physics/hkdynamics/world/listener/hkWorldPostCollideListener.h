...
class hkStepInfo;
	...
	/// Add to the world using hkWorld::addWorldPostCollideListener
class hkWorldPostCollideListener
{
	public:

		virtual ~hkWorldPostCollideListener() {}
		...
		virtual void postCollideCallback( hkWorld* world, const hkStepInfo& stepInfo ) = 0;
};
