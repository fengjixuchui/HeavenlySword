...
class hkWorldPostIntegrateListener
{
	public:
		...
		virtual ~hkWorldPostIntegrateListener() {}

			/// Called at the end of the hkWorld::integrate call.
		virtual void postIntegrateCallback( hkWorld* world, const hkStepInfo& stepInfo ) = 0;
};
