...
class hkWorldViewerBase :   public hkReferencedObject, 
							public hkProcess,
							protected hkPhysicsContextWorldListener
{
	public:
		...
		hkWorldViewerBase( const hkArray<hkProcessContext*>& contexts );

		// Dtor will unregister as all the listeners, from the context if any
		virtual ~hkWorldViewerBase();
