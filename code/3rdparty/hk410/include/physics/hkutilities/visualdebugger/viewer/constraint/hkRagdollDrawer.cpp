...
void hkRagdollDrawer::drawConstraint(hkConstraintInstance* constraint, hkDebugDisplayHandler* displayHandler, int tag)
{
	hkRagdollConstraintData* ragdoll = static_cast<hkRagdollConstraintData*>(constraint->getData());
	...
	const hkRagdollConstraintData::Atoms& atoms = ragdoll->m_atoms;
