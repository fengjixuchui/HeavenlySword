...
class hkConstraintChainDrawer : public hkConstraintDrawer
{
	public:

		void drawConstraint(hkConstraintInstance* constraint, hkDebugDisplayHandler* displayHandler, int tag);
};
