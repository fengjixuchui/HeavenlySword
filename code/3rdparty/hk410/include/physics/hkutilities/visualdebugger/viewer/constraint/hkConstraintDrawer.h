...
class hkConstraintDrawer 
{
	public:

		//HK_DECLARE_CLASS_ALLOCATOR(HK_MEMORY_CLASS_UTILITY);
	...
	protected:
		...
		void updateCommonParameters(hkConstraintInstance* constraint,hkTransform& refLocalToWorld,hkTransform& attLocalToWorld);
		...
		hkPrimitiveDrawer m_primitiveDrawer;
};
