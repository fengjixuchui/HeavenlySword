...
#ifndef HK_UTILITIES2_FORCED_CONTACT_POINT_VIEWER_H
#define HK_UTILITIES2_FORCED_CONTACT_POINT_VIEWER_H
...
class hkListener;
	...
	/// Displays contact points as they are added to the system.  Warning - this viewer modifies this simulation by reducing 
    /// the m_processContactCallbackDelay of viewable entities to 0.
class hkForcedContactPointViewer : public hkWorldViewerBase, protected hkCollisionListener
{
	public:
		...
		static inline const char* HK_CALL getName() { return "ForcedContactPoints (See Docs For Usage)"; }
		
	protected:

		hkForcedContactPointViewer(const hkArray<hkProcessContext*>& contexts);
		virtual ~hkForcedContactPointViewer();
...
#endif	// HK_UTILITIES2_FORCED_CONTACT_POINT_VIEWER_H
