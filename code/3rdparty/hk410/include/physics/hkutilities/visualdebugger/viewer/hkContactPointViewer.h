...
class hkListener;
	...
	/// Displays contact points as they are added to the system.
class hkContactPointViewer : public hkWorldViewerBase, protected hkCollisionListener
{
	public:
		...
		static inline const char* HK_CALL getName() { return "ContactPoints"; }
		
	protected:

		hkContactPointViewer(const hkArray<hkProcessContext*>& contexts);
		virtual ~hkContactPointViewer();
