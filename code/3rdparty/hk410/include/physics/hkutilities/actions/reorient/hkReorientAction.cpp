...
HK_REFLECTION_DEFINE_VIRTUAL(hkReorientAction);

hkReorientAction::hkReorientAction()
...
hkReorientAction::hkReorientAction( hkRigidBody* body,
...
void hkReorientAction::applyAction( const hkStepInfo& stepInfo )
{
...
hkAction* hkReorientAction::clone( const hkArray<hkEntity*>& newEntities, const hkArray<hkPhantom*>& newPhantoms ) const
{
	...
	hkReorientAction* ra = new hkReorientAction( (hkRigidBody*)newEntities[0], m_rotationAxis, 
