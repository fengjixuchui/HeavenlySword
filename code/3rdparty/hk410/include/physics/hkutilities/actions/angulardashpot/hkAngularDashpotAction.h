...
/// constraints, and is the rotational equivalent of an hkDashpotAction.
...
class hkAngularDashpotAction : public hkBinaryAction
{
	public:
		...
		hkAngularDashpotAction(hkRigidBody* entityA = HK_NULL, hkRigidBody* entityB = HK_NULL, hkUint32 userData = 0);
	...
	public:
		...
		hkAngularDashpotAction( class hkFinishLoadedObjectFlag flag ) : hkBinaryAction(flag) {}

};

#include <hkutilities/actions/angulardashpot/hkAngularDashpotAction.inl>
