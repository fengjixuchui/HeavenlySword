...
class hkMotorAction: public hkUnaryAction
{
	public:
		...
		inline hkMotorAction();

			/// Creates a new hkMotorAction.
		hkMotorAction(hkRigidBody* body, const hkVector4& axis, hkReal spinRate, hkReal gain = 2.0f);
	...
	public:
		...
		hkMotorAction( class hkFinishLoadedObjectFlag flag ) : hkUnaryAction(flag) {}

};

#include <hkutilities/actions/motor/hkMotorAction.inl>
