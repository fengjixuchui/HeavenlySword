...
hkCharacterStateType hkCharacterStateFlying::getType() const 
{
	return HK_CHARACTER_FLYING;
}

	// Process the user input - causes state transitions etc.
void hkCharacterStateFlying::update(hkCharacterContext& context, const hkCharacterInput& input, hkCharacterOutput& output)
{
}
