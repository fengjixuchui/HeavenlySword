...
class hkCharacterStateOnGround : public hkCharacterState
{
	public:

		hkCharacterStateOnGround();
		...
		void setSpeed(hkReal newGain);
			...
			/// Returns the ground hugging status
		...
		hkBool getLimitDownwardVelocity();
