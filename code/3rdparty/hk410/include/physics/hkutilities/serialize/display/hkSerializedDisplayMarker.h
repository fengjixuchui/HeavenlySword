...
class hkSerializedDisplayMarker : public hkReferencedObject
{
public:
	...
	inline hkSerializedDisplayMarker();

public:

	hkTransform m_transform; // the transform for this marker.
	hkSerializedDisplayMarker(hkFinishLoadedObjectFlag) { }
};

#include <hkutilities/serialize/display/hkSerializedDisplayMarker.inl>
