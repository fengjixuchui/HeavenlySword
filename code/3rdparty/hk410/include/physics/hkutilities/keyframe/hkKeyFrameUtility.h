...
class hkKeyFrameUtility
{
	public:
		...
		///You use an AccelerationInfo to specify acceleration details for hkKeyFrameUtility::applySoftKeyFrame
		struct AccelerationInfo
		{
			...
			/// You use a KeyFrameInfo to specify keyframe details for hkKeyFrameUtility::applySoftKeyFrame.
		...
		static void HK_CALL applySoftKeyFrame( const KeyFrameInfo& keyFrameInfo, AccelerationInfo& accelInfo, hkReal deltaTime, hkReal invDeltaTime, hkRigidBody* body );
		...
		static void HK_CALL applyHardKeyFrame( const hkVector4& nextPosition, const hkQuaternion& nextOrientation, hkReal invDeltaTime, hkRigidBody* body);
