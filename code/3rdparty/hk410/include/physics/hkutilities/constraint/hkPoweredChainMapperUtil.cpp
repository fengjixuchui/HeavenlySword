...
void hkPoweredChainMapperUtil::addToWorld(hkWorld* world, hkPoweredChainMapper* mapper)
{
	...
	{
		hkConstraintInstance* instance = mapper->m_links[l].m_limitConstraint;
		if (instance)
		{
...
void hkPoweredChainMapperUtil::removeFromWorld(hkWorld* world, hkPoweredChainMapper* mapper)
{
	for (int c = 0; c < mapper->m_chains.getSize(); c++)
	{
