...
void HK_CALL hkAsynchronousTimestepper::stepAsynchronously( hkWorld* world, hkReal frameDeltaTime, hkReal physicsDeltaTime )
{
	HK_WARN_ONCE(0xafe97523, "This utility is intended primarily for Havok demo use. If you wish to step the world asychronously, you \
