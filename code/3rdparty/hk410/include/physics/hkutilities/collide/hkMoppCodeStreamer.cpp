...
hkMoppCode* HK_CALL hkMoppCodeStreamer::readMoppCodeFromArchive(hkIArchive &inputArchive)
{
	...
	hkMoppCode* code = new hkMoppCode();
...
void HK_CALL hkMoppCodeStreamer::writeMoppCodeToArchive(const hkMoppCode* code, hkOArchive &outputArchive)
{
