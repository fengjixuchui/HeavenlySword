...
struct hkUsedImpulseFactor
{
	/// a value between 0 and 1 indicating if the motor was reaching is max force
	hkReal				m_usedImpulseFactor;
};

struct hk1dAngularMotorSolverInfo: public hkUsedImpulseFactor
{
	public:
...
struct hk3dAngularMotorSolverInfo
{
	...
	hk1dAngularMotorSolverInfo m_motorInfos[3];
};
