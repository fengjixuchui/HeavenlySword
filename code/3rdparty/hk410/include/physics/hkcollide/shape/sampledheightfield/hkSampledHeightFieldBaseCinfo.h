...
/// hkSampledHeightFieldBaseCinfo meta information
extern const class hkClass hkSampledHeightFieldBaseCinfoClass;

/// The information needed to construct an hkSampledHeightFieldBase
class hkSampledHeightFieldBaseCinfo
{
	public:
	
			/// Default constructor
		hkSampledHeightFieldBaseCinfo()
		{
