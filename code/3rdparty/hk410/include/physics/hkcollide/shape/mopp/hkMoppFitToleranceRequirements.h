...
#ifndef HK_COLLIDE2_MOPP_FIT_TOLERANCE_REQUIREMENTS_H
#define HK_COLLIDE2_MOPP_FIT_TOLERANCE_REQUIREMENTS_H

#include <hkmath/hkMath.h>

/// This class holds the parameters that affect the building of an hkMoppCode. See the following long description for details.
/// The hkMoppFitToleranceRequirements will be 
...
/// with the appropriate methods before the hkMoppCode is built. The following
...
/// is then passed to the narrow phase collision detection. You can view
...
/// of its children.
/// The nodes on the leaf levels encapsulate one hkShape, normally a
...
/// The MOPP building process uses the hkMoppFitToleranceRequirements to allow you to specify which is 
...
/// </ul>
class hkMoppFitToleranceRequirements : public hkReferencedObject
{
	public:
...
#endif // HK_COLLIDE2_MOPP_FIT_TOLERANCE_REQUIREMENTS_H
