...
void hkCylinderShape::setVertex(int i, const hkVector4& position )
{
...
const hkVector4* hkCylinderShape::getVertices() const
{
	return &m_vertexA;
}

const hkVector4& hkCylinderShape::getVertex(int i) const
{
