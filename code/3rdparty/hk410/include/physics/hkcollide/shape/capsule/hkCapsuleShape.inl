...
void hkCapsuleShape::setVertex(int i, const hkVector4& position )
{
...
const hkVector4* hkCapsuleShape::getVertices() const
{
	return &m_vertexA;
}

const hkVector4& hkCapsuleShape::getVertex(int i) const
{
