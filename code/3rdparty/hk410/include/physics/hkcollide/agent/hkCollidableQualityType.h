...
#define HK_COLLIDE2_COLLIDABLE_QUALITY_TYPE_H
	...
	/// This type is used to specify the quality type for collidables (used by hkRigidBody)
	...
	/// See the continuous simulation user guide, of the hkCollisionDispatcher for more details
enum hkCollidableQualityType
{
		/// Invalid or unassinged type. If you add a hkRigidBody to the hkWorld,
	...
	HK_COLLIDABLE_QUALITY_BULLET,
		...
		/// For user. If you want to use this, you have to modify hkCollisionDispatcher::initCollisionQualityInfo()
