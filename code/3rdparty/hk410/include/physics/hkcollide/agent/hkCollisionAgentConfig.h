...
/// This structure combines several configuration variables for hkCollisionAgent
/// Note:
...
{
	HK_DECLARE_NONVIRTUAL_CLASS_ALLOCATOR(HK_MEMORY_CLASS_AGENT, hkCollisionAgentConfig);
	
	hkReal m_iterativeLinearCastEarlyOutDistance;
	int m_iterativeLinearCastMaxIterations;

	inline hkCollisionAgentConfig();
};

#include <hkcollide/agent/hkCollisionAgentConfig.inl>
