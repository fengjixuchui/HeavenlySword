...
/// The base class to collect hkContactPoint and hkCdBody information from the collision detection<br>
...
class hkCdPointCollector
{
	public:
		...
		inline hkCdPointCollector();

		inline virtual ~hkCdPointCollector();
...
#include <hkcollide/agent/hkCdPointCollector.inl>
