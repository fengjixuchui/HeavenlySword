...
HK_REFLECTION_DEFINE_VIRTUAL(hkDefaultConvexListFilter);


hkConvexListFilter::ConvexListCollisionType hkDefaultConvexListFilter::getConvexListCollisionType(	const hkCdBody& convexListBody, 
																									const hkCdBody& otherBody, 
																									const hkCollisionInput& input ) const
{
	
	hkShapeType shapeType = otherBody.getShape()->getType();
