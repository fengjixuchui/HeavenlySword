...
class hkConvexListFilter : public hkReferencedObject
{
	public:
		...
		virtual ConvexListCollisionType getConvexListCollisionType( const hkCdBody& convexListBody, const hkCdBody& otherBody, const hkCollisionInput& input ) const = 0;
};
