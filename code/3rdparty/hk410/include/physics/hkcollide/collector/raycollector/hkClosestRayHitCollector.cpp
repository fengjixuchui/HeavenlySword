...
void hkClosestRayHitCollector::addRayHit( const hkCdBody& cdBody, const hkShapeRayCastCollectorOutput& hitInfo )
{
	if ( hitInfo.m_hitFraction < m_rayHit.m_hitFraction)
	{
		static_cast<hkShapeRayCastCollectorOutput&>( m_rayHit ) = hitInfo;
