...
//
// hkMoppIntAabbVirtualMachine Constructor
//
hkMoppIntAabbVirtualMachine::hkMoppIntAabbVirtualMachine()
{
}

//
// hkMoppIntAabbVirtualMachine Destructor
//
hkMoppIntAabbVirtualMachine::~hkMoppIntAabbVirtualMachine()
{
	// nothing to do
...
void hkMoppIntAabbVirtualMachine::generateQueryFromAabb(const hkVector4& aabbMin, const hkVector4& aabbMax, hkMoppIntAabbVirtualMachineQuery& query)
{
