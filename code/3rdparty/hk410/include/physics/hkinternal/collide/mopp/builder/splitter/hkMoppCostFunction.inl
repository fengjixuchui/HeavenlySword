...
hkReal hkMoppCostFunction::costPrimitiveSplits(const hkMoppCostFunction::hkPlanesParams& p)
{
...
hkReal hkMoppCostFunction::directionCost(const hkMoppCostFunction::hkPlaneRightParams& planeRightInfo)
{
...
hkReal hkMoppCostFunction::costPlaneDistance(const hkMoppCostFunction::hkPlanesParams& p)
{
...
hkReal hkMoppCostFunction::costNumUnBalanced(const hkMoppCostFunction::hkPlanesParams& p)
{
...
hkReal hkMoppCostFunction::costUnbalancedPlaneRight(const hkMoppCostFunction::hkPlaneRightParams& p)
{
...
hkReal hkMoppCostFunction::costUnbalancedPlaneLeft(const hkMoppCostFunction::hkPlanesParams& p)
{
	const hkReal center = 0.5f * ( p.m_absoluteMax + p.m_absoluteMin );
...
hkReal hkMoppCostFunction::costprimitiveIdSpread( const hkMoppCostFunction::hkPlaneRightParams& p )
{
...
hkReal hkMoppCostFunction::costPlaneRight(const hkMoppCostFunction::hkPlaneRightParams& planeRightInfo)
{
	hkMoppBasicNode::hkMoppCostInfo ci;
...
hkReal hkMoppCostFunction::extraCostPlaneLeft(const hkMoppCostFunction::hkPlanesParams& p2)
{
	hkMoppBasicNode::hkMoppCostInfo ci;
...
void hkMoppCostFunction::debugCosts ( const hkMoppCostFunction::hkPlanesParams& p, hkMoppBasicNode::hkMoppCostInfo& ci )
{
