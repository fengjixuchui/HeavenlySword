...
extern const hkClass hkSkeletonMapperDataClass;
	...
	/// hkSkeletonMapperData is the data used at run-time by an hkSkeletonMapper. It consists of a set of
	/// both simple (one-to-one) and chain (m-to-n) mappings.
	/// The information in this class can easily be generated by the utility class hkSkeletonMapperUtils
class hkSkeletonMapperData 
{
	public:

		HK_DECLARE_NONVIRTUAL_CLASS_ALLOCATOR( HK_MEMORY_CLASS_ANIM_RIG, hkSkeletonMapperData );
		...
		hkSkeletonMapperData( hkFinishLoadedObjectFlag f ) : m_simpleMappings(f), m_chainMappings(f), m_unmappedBones(f) {} // do nothing.
