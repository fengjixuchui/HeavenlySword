...
class hkRagdollPoweredConstraintController
{
	public:
		...
		static void HK_CALL driveToPose( hkRagdollInstance* ragdoll, const hkQsTransform* poseLocalSpace );

			/// Enables the motors in all the powered constraints associated with the joints of this ragdoll instance.
		static void HK_CALL startMotors( hkRagdollInstance* ragdoll );

			/// Disables the motors of the powered constraints associated with the joints of this ragdoll instance.
		static void HK_CALL stopMotors( hkRagdollInstance* ragdoll );
