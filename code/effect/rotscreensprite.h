//------------------------------------------------------------------------------------------
//!
//!	\file rotscreensprite.h
//! A rotated screen space quad sprite with a single texture and colour
//!
//------------------------------------------------------------------------------------------

#ifndef	ROT_SCREEN_SPRITE_H
#define	ROT_SCREEN_SPRITE_H
...
//!
//------------------------------------------------------------------------------------------
class RotScreenSprite
{
public:

	// Construction / Destruction
	RotScreenSprite( int iNumberOfSprites = 1 );
	...
	void SetAngle( const float fAngle, int iItem = 0 );
...
private:
	...
	enum VERTEX_ELEMENTS
	{
		...
		VE_ANGLE		= PV_ELEMENT_5,
		VE_CORNER		= PV_ELEMENT_6,
	};
	...
	struct Vertex
	{
		Vertex()
		{
			...
			m_col[0] = (NTFLOAT16)1.0f;	m_col[1] = (NTFLOAT16)1.0f;
			m_col[2] = (NTFLOAT16)1.0f;	m_col[3] = (NTFLOAT16)1.0f;
		...
		void SetAngle( const float fAngle ) { m_angle = fAngle; }
