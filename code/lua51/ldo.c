...
void luaD_throw (lua_State *L, int errcode) {int x;

  x = 1; // Conditional expressions should never be constant, oh no...
  ntError_p(x==1, ("luaD_throw - Unhandled lua error"));
...
#ifdef _WIN32
	MessageBox(GetForegroundWindow(), "luaD_throw", "Unhandled lua error", MB_OK);
#endif
