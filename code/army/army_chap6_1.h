...
#ifndef ARMY_CHAP6_1_H_
#define ARMY_CHAP6_1_H_
...
//! army section in Chapter 6 section 1
//!
//------------------------------------------------------
class ArmyChap6_1 : public ArmySection
{
public:
	// note these pointer may be deleted afterwards!
	ArmyChap6_1( const ArmyBattlefield* pArmyArena );
	virtual ~ArmyChap6_1();
