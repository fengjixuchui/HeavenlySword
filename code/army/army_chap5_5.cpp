...
//!
//------------------------------------------------------
ArmyChap5_5::ArmyChap5_5( const ArmyBattlefield* pArmyArena ) :
...
void ArmyChap5_5::CreateSmallSquare( const ArmyBattalion* pBattalionDef, const BattlefieldHeader* pBattlefieldHeader, Battalion* pBattalion, TempGruntVector& grunts )
{
	...
	pBattalion->m_Orders = BO_TAUNT;				// start with a forward march
...
void ArmyChap5_5::CreateMediumSquare( const ArmyBattalion* pBattalionDef, const BattlefieldHeader* pBattlefieldHeader, Battalion* pBattalion, TempGruntVector& grunts )
{
...
void ArmyChap5_5::CreateLargeSquare( const ArmyBattalion* pBattalionDef, const BattlefieldHeader* pBattlefieldHeader, Battalion* pBattalion, TempGruntVector& grunts )
{
...
void ArmyChap5_5::CreateSmallRectangle( const ArmyBattalion* pBattalionDef, const BattlefieldHeader* pBattlefieldHeader, Battalion* pBattalion, TempGruntVector& grunts )
{
...
void ArmyChap5_5::CreateMediumRectangle( const ArmyBattalion* pBattalionDef, const BattlefieldHeader* pBattlefieldHeader, Battalion* pBattalion, TempGruntVector& grunts )
{
...
void ArmyChap5_5::CreateLargeRectangle( const ArmyBattalion* pBattalionDef, const BattlefieldHeader* pBattlefieldHeader, Battalion* pBattalion, TempGruntVector& grunts )
{
...
void ArmyChap5_5::SectionConstruct()
{
	// FROM THE SCRIPT 
...
//!
//------------------------------------------------------
void ArmyChap5_5::Update( float fTimeStep )
{
...
//!
//------------------------------------------------------
void ArmyChap5_5::ProcessGlobalEvent( const CHashedString obGlobalEvent )
{
	if( m_pBattlefield == 0 )
		return;
