...
//!
//------------------------------------------------------
ArmyChap1_1::ArmyChap1_1( const ArmyBattlefield* pArmyArena ) :
...
void ArmyChap1_1::CreateSmallSquare( const ArmyBattalion* pBattalionDef, const BattlefieldHeader* pBattlefieldHeader, Battalion* pBattalion, TempGruntVector& grunts )
{
...
void ArmyChap1_1::CreateMediumSquare( const ArmyBattalion* pBattalionDef, const BattlefieldHeader* pBattlefieldHeader, Battalion* pBattalion, TempGruntVector& grunts )
{
...
void ArmyChap1_1::CreateLargeSquare( const ArmyBattalion* pBattalionDef, const BattlefieldHeader* pBattlefieldHeader, Battalion* pBattalion, TempGruntVector& grunts )
{
	...
	pBattalion->m_ShapeData.m_OrderedLine.m_UnitInLine[2] = NIBBLE_PACK( BUT_FODDER, 0 );

	FillInOrderedLineBattalion( pBattalionDef, pBattlefieldHeader, pBattalion, grunts );
}
void ArmyChap1_1::CreateSmallRectangle( const ArmyBattalion* pBattalionDef, const BattlefieldHeader* pBattlefieldHeader, Battalion* pBattalion, TempGruntVector& grunts )
{
...
void ArmyChap1_1::CreateMediumRectangle( const ArmyBattalion* pBattalionDef, const BattlefieldHeader* pBattlefieldHeader, Battalion* pBattalion, TempGruntVector& grunts )
{
...
void ArmyChap1_1::CreateLargeRectangle( const ArmyBattalion* pBattalionDef, const BattlefieldHeader* pBattlefieldHeader, Battalion* pBattalion, TempGruntVector& grunts )
{
...
void ArmyChap1_1::SectionConstruct()
{
	// FROM THE SCRIPT 
...
//!
//------------------------------------------------------
void ArmyChap1_1::Update( float fTimeStep )
{
...
//!
//------------------------------------------------------
void ArmyChap1_1::ProcessGlobalEvent( const CHashedString obGlobalEvent )
{
#if !defined(_RELEASE )
