...
//!
//------------------------------------------------------
ArmyChap5_3::ArmyChap5_3( const ArmyBattlefield* pArmyArena ) :
...
void ArmyChap5_3::CreateSmallSquare( const ArmyBattalion* pBattalionDef, const BattlefieldHeader* pBattlefieldHeader, Battalion* pBattalion, TempGruntVector& grunts )
{
...
void ArmyChap5_3::CreateMediumSquare( const ArmyBattalion* pBattalionDef, const BattlefieldHeader* pBattlefieldHeader, Battalion* pBattalion, TempGruntVector& grunts )
{
...
void ArmyChap5_3::CreateLargeSquare( const ArmyBattalion* pBattalionDef, const BattlefieldHeader* pBattlefieldHeader, Battalion* pBattalion, TempGruntVector& grunts )
{
...
void ArmyChap5_3::CreateSmallRectangle( const ArmyBattalion* pBattalionDef, const BattlefieldHeader* pBattlefieldHeader, Battalion* pBattalion, TempGruntVector& grunts )
{
...
void ArmyChap5_3::CreateMediumRectangle( const ArmyBattalion* pBattalionDef, const BattlefieldHeader* pBattlefieldHeader, Battalion* pBattalion, TempGruntVector& grunts )
{
...
void ArmyChap5_3::CreateLargeRectangle( const ArmyBattalion* pBattalionDef, const BattlefieldHeader* pBattlefieldHeader, Battalion* pBattalion, TempGruntVector& grunts )
{
...
void ArmyChap5_3::SectionConstruct()
{
	// FROM THE SCRIPT 
...
//!
//------------------------------------------------------
void ArmyChap5_3::Update( float fTimeStep )
{
...
//!
//------------------------------------------------------
void ArmyChap5_3::ProcessGlobalEvent( const CHashedString obGlobalEvent )
{
