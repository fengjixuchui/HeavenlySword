...
//!
//------------------------------------------------------
ArmyChap5_2::ArmyChap5_2( const ArmyBattlefield* pArmyArena ) :
...
void ArmyChap5_2::CreateSmallSquare( const ArmyBattalion* pBattalionDef, const BattlefieldHeader* pBattlefieldHeader, Battalion* pBattalion, TempGruntVector& grunts )
{
...
void ArmyChap5_2::CreateMediumSquare( const ArmyBattalion* pBattalionDef, const BattlefieldHeader* pBattlefieldHeader, Battalion* pBattalion, TempGruntVector& grunts )
{
...
void ArmyChap5_2::CreateLargeSquare( const ArmyBattalion* pBattalionDef, const BattlefieldHeader* pBattlefieldHeader, Battalion* pBattalion, TempGruntVector& grunts )
{
...
void ArmyChap5_2::CreateSmallRectangle( const ArmyBattalion* pBattalionDef, const BattlefieldHeader* pBattlefieldHeader, Battalion* pBattalion, TempGruntVector& grunts )
{
...
void ArmyChap5_2::CreateMediumRectangle( const ArmyBattalion* pBattalionDef, const BattlefieldHeader* pBattlefieldHeader, Battalion* pBattalion, TempGruntVector& grunts )
{
...
void ArmyChap5_2::CreateLargeRectangle( const ArmyBattalion* pBattalionDef, const BattlefieldHeader* pBattlefieldHeader, Battalion* pBattalion, TempGruntVector& grunts )
{
...
void ArmyChap5_2::SectionConstruct()
{
	// FROM THE SCRIPT 
...
//!
//------------------------------------------------------
void ArmyChap5_2::Update( float fTimeStep )
{
...
//!
//------------------------------------------------------
void ArmyChap5_2::ProcessGlobalEvent( const CHashedString obGlobalEvent )
{
