...
#ifndef ARMY_CHAP5_1_H_
#define ARMY_CHAP5_1_H_
...
//!
//------------------------------------------------------
class ArmyChap5_1 : public ArmySection
{
public:
	// note these pointer may be deleted afterwards!
	ArmyChap5_1( const ArmyBattlefield* pArmyArena );
	virtual ~ArmyChap5_1();
...
private:
	...
	void CreateLargeRectangle( const ArmyBattalion* pBattalionDef, 
							const BattlefieldHeader* pBattlefieldHeader, 
							Battalion* pBattalion, TempGruntVector& grunts );
	void Create_bombermen( const ArmyBattalion* pBattalionDef, 
							const BattlefieldHeader* pBattlefieldHeader, 
							Battalion* pBattalion, TempGruntVector& grunts );

	// when we last sent the explode message
	uint32_t m_iLastExplodeCount;

};
#endif	// !ARMY_CHAP5_1_H_
