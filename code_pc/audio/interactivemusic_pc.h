#ifndef	_INTERACTIVEMUSIC_PC_H
#define	_INTERACTIVEMUSIC_PC_H
...
public:
	...
	CKeyString		m_obWaveFile;		// Wave file ID
	CKeyString		m_obWaveBank;		// Wave bank ID
...
private:
	...
	CKeyString					m_obName; // Name of this music track
