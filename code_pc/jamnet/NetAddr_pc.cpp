...
{
	m_addr.sin_family = AF_INET;
	m_addr.sin_addr.S_un.S_addr = htonl(lIPAddr);
	m_addr.sin_port = htons(iPort);
}
...
{
	m_addr.sin_family = AF_INET;
	m_addr.sin_addr.S_un.S_addr = obRHS.m_addr.sin_addr.S_un.S_addr;
...
{
	if(m_addr.sin_addr.S_un.S_addr != obRHS.m_addr.sin_addr.S_un.S_addr)
		return false;
