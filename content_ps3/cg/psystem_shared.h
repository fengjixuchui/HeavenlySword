...
struct POINT_VS_OUTPUT_PALETTE
{
	float4 	pos			: POSITION0;
	float	size		: PSIZE0;
	float2	texcoord	: TEXCOORD0;
...
// defines
#define SIZE_FUNCTION1_INDEX (0.25f)
#define SIZE_FUNCTION2_INDEX (0.75f)

// texture mode
#define PTM_UNTEXTURED			0
#define PTM_SIMPLE_TEXTURED		1
#define PTM_ANIM_TEXTURED		2
#define PTM_RAND_TEXTURED		3
...
//--------------------------------------------------
//!
//!	psystem_GetAnimTexColour
//!
//--------------------------------------------------
float4 psystem_GetAnimTexColour( float age, float2 texcoord, uniform sampler2D tosample )
{
	// get index of first texture to use.		
	float textureIndexR = age * m_TA_numTex;
