...
#ifndef _AUDIOMANAGER_PS3_H
#define _AUDIOMANAGER_PS3_H
...
public:
	...
	{
		AOF_FLAG_LOOPING		= 1, // Does this sound loop?
		AOF_FLAG_REVERB			= 2, // Directsound reverb EQ
		AOF_FLAG_PARAMEQ		= 4, // Directsound param EQ
	};
	...
	void SetName (CHashedString obSoundCue, CHashedString obSoundBank);
	...
	const CHashedString& GetSoundCueName () { return m_obSoundCue; }
	const CHashedString& GetSoundBankName () { return m_obSoundBank; }
...
private:
	...
	CHashedString m_obSoundCue;
	CHashedString m_obSoundBank;
...
public:
	...
	bool Create (CAudioObjectID& obID,const CHashedString& obBank,const CHashedString& obCue,SPATIALIZATION eSpatialType);
