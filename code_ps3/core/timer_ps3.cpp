...
double	CTimer::m_dTimerPeriod		= 0.0;
double	CTimer::m_dTimerPeriodFrame = 0.0;
...
CTimer::CTimer()
{
    ...
    m_dTimerPeriod			= 1.0 / ( double )( timerFrequency );
	m_dTimerPeriodFrame		= 1.0 / ( double )( timerFrequency / GraphicsDevice::Get().GetGameRefreshRate() );
...
void CTimer::Update( bool bGameTimePaused )
{
	...
	// ... bask to life, sorry guys :P MONSTERS\Frank 08/03/2006 17:33:32 
