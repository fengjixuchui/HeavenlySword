...
namespace Ice
{
	namespace Render
	{
		...
		struct GpuHardwareConfig
		{
			...
			//! The gpu channel handle for the software driver.
			U32 m_swDriverHandle;
		...
		*/
		inline U32 TranslateAddressToOffset(void const *addr)
		{
		...
		inline U32 TranslateAddressToOffset(void *addr) { return TranslateAddressToOffset(const_cast<void const *>(addr)); }
		inline U32 TranslateAddressToOffset(void volatile *addr) { return TranslateAddressToOffset(const_cast<void const *>(addr)); }
		...
		*/
		inline void *TranslateOffsetToAddress(U32 offset)
		{
		...
		*/
		inline U32 TranslateAddressToIoOffset(void const *addr)
		{
		...
		inline U32 TranslateAddressToIoOffset(void *addr) { return TranslateAddressToIoOffset(const_cast<void const *>(addr)); }
		inline U32 TranslateAddressToIoOffset(void volatile *addr) { return TranslateAddressToIoOffset(const_cast<void const *>(addr)); }
		...
		*/
		inline void *TranslateIoOffsetToAddress(U32 offset)
		{
...
namespace Ice
{
	namespace Render
	{
		...
		*/
		inline bool TestReference(I32 value)
		{
		...
		*/
		inline volatile U32 *GetSemaphoreAddress(U32 index)
		{
		...
		*/
		inline U32 GetSemaphoreValue(U32 index)
		{
			ICE_ASSERT(index < kMaxSemaphores);
			return *(volatile U32*)(g_gpuHardwareConfig.m_semaphoreBaseAddress + index * g_gpuHardwareConfig.m_semaphoreStride);
		}
		...
		*/
		inline void SetSemaphoreValue(U32 index, U32 value)
		{
			ICE_ASSERT(index < kMaxSemaphores);
