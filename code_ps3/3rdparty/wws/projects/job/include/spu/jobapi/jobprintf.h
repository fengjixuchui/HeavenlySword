...
#ifndef WWS_JOB_SPU_PRINTF_H
#define WWS_JOB_SPU_PRINTF_H
...
#undef spu_printf
#define spu_printf( a, varargs... ) Error_PleaseDoNotUseNonInterruptSafeVersionOf_spu_printf( a, ##varargs )

//--------------------------------------------------------------------------------------------------

#endif /* WWS_JOB_SPU_PRINTF_H */
