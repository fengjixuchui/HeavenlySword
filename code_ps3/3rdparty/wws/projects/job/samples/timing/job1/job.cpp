...
{	
	...
	WwsJob_JobApiStoreAudit( AuditId::kTimingJob1_begin, 0,
	...
	WwsJob_JobApiStoreAudit( AuditId::kTimingJob1_codeBuffer, 0,
	...
	// use audit to print lsa of code buffer (to verify which of 2 buffers it went to)
	WwsJob_JobApiStoreAudit( AuditId::kTimingJob1_dataBuffer, 0,
	...
	// end job audit
	WwsJob_JobApiStoreAudit( AuditId::kTimingJob1_end );
}
