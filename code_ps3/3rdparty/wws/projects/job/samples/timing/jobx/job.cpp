...
void JobMain( U32 param0, U32 param1, U32 param2, U32 param3, U32 param4, U32 param5, U32 param6, U32 param7  )
{
	...
	WwsJob_JobApiStoreAudit( AuditId::kTimingJobx_begin, 0,
	...
	WwsJob_JobApiStoreAudit( AuditId::kTimingJobx_codeBuffer, 0,
	...
	// use audit to print lsa of code buffer (to verify which of 2 buffers it went to)
	WwsJob_JobApiStoreAudit( AuditId::kTimingJobx_dataBuffer, 0,
	...
	// end job audit
	WwsJob_JobApiStoreAudit( AuditId::kTimingJobx_end );
}
