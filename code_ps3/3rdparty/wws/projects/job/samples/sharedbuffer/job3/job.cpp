...
void JobMain( void )
{
	...
	WwsJob_JobApiStoreAudit( AuditId::kSharedBufferJob3_begin, (8 >> 1)/*#dwords*/, pParams );
	...
	WwsJob_JobApiStoreAudit( AuditId::kSharedBufferJob3_codeBuffer, 0,
	...
	// use audit to print lsa of code buffer (to verify which of 2 buffers it went to)
	WwsJob_JobApiStoreAudit( AuditId::kSharedBufferJob3_dataBuffer, 0,
	...
	// end job audit
	WwsJob_JobApiStoreAudit( AuditId::kSharedBufferJob3_end );
}
